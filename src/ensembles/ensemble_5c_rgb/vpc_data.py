...
def load_training_data(validation_split=0.2):
    ...
    TRAIN_RGB_DIR_PATH = "../../data/working/train" 

    gray_image_data = []
    image_labels = []
    
    folders = os.listdir(TRAIN_RGB_DIR_PATH)
    ...
    for i in range(43):
        ...
        training_gray_data_path = f"{TRAIN_RGB_DIR_PATH}/{folder}"
    ...
    print("X_train_rgb.shape", X_train_gray.shape)
    print("X_valid_rgb.shape", X_val_gray.shape)
...
def load_testing_data():
    ...
    TEST_GRAY_DIR_PATH = "../../data/working/test" 
    ...
    print("test_rgb data shape: ", gray_image_data.shape)
